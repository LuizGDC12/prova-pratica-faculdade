...
$inimigos = [
    1 => ["nome" => "Goblin Selvagem",       "emoji" => "👺", "vida" => 50,  "ataque" => 4],
    2 => ["nome" => "Orc Guerreiro",          "emoji" => "👹", "vida" => 65,  "ataque" => 8],
    3 => ["nome" => "Dragão Jovem",           "emoji" => "🐉", "vida" => 75, "ataque" => 9],
    4 => ["nome" => "Cavaleiro das Trevas",   "emoji" => "⚔️", "vida" => 90, "ataque" => 10],
    5 => ["nome" => "Keffler, o Rei Demônio", "emoji" => "👿", "vida" => 140, "ataque" => 15],
];
